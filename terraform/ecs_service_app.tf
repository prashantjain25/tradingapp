...
resource "aws_ecs_service" "default" {
  ...
  # 2023-03-05 17:44:11.314  INFO 7 --- [           main] org.osttra.feeproducer.App                              : Started App in 88.608 seconds (JVM running for 93.593)
  health_check_grace_period_seconds = 300

  load_balancer {
    target_group_arn = aws_alb_target_group.default.arn
    container_name   = "feeconsumer"
    container_port   = 8080
  }
}
